...
const FooterComp = () => {
  return (
    <>
    <footer className="bg-gradient-to-b from-green-100 to-green-200 dark:from-green-900 dark:to-green-950 text-gray-800 dark:text-white py-12 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <div className="flex items-center gap-2">
                <div className="flex items-center justify-center p-2 rounded-full bg-green-200/60 dark:bg-green-800/40">
                  <Leaf className="w-6 h-6 text-green-600 dark:text-green-400" />
                </div>
                <span className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-500 dark:from-green-400 dark:to-emerald-300">econft</span>
              </div>
            ...
            <div>
              <h3 className="text-sm font-semibold uppercase tracking-wider text-green-600 dark:text-green-400">
                Links
              </h3>
              <ul className="mt-4 space-y-2">
                <li>
                  <a href="/about" className="text-gray-600 dark:text-gray-300 hover:text-green-600 dark:hover:text-green-400 transition-colors duration-200">
                    About
                  </a>
                </li>
                <li>
          ...
          <div className="mt-8 pt-8 border-t border-green-300/50 dark:border-green-800/50 text-center text-gray-600 dark:text-gray-300 relative">
