...
const StepCard = ({ number, icon, title, description }: StepCardProps) => {
  ...
  return (
    <div
      ref={containerRef}
      className="bg-green-100/60 dark:bg-green-900/40 backdrop-blur-sm border border-green-200 dark:border-green-800/50 rounded-lg p-6 h-full transition-all duration-300 hover:shadow-lg hover:shadow-green-500/10 hover:border-green-300 dark:hover:border-green-700/50 relative overflow-hidden"
    ...
    >
      ...
      <div className="relative z-10">
        <div className="flex items-center mb-4 text-green-500">
          <div className="flex items-center justify-center w-10 h-10 rounded-full bg-green-200/70 dark:bg-green-950/70 mr-3">
            {icon}
          </div>
