...
export default function PurchaseModal({
    ...
    return (
      <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-2">
        <div className="bg-white dark:bg-green-900/90 dark:border dark:border-green-800/50 rounded-2xl p-8 max-w-md w-full space-y-6 animate-fade-in relative">
          <button
            onClick={onClose}
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-emerald-600 dark:text-emerald-400 font-bold">{tree.price / 1e5} ETH</p>
              </div>
            </div>
          ...
          <div className="flex gap-4">
            <button
              onClick={onClose}
              className="flex-1 px-6 py-3 border-2 border-gray-200 dark:border-green-800 text-gray-700 dark:text-gray-300 font-semibold rounded-xl
                hover:bg-gray-50 dark:hover:bg-green-800/50 transition-colors"
            >
              Cancel
            </button>
            <button
